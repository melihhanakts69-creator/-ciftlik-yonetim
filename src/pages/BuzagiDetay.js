...
const BuzagiDetay = () => {
    ...
    return (
        <DetailContainer>
            ...
            <QuickRow>
                <ActionButton onClick={handleGecisYap} style={{ backgroundColor: '#e8f5e9', color: '#2e7d32', flex: 1, minWidth: 110 }}>
                    <FaArrowRight /> {isDisi ? 'Düveye' : 'Tosuna'} Transfer
                </ActionButton>
                <ActionButton onClick={() => setShowKiloModal(true)} style={{ backgroundColor: '#fff3e0', color: '#ef6c00', flex: 1, minWidth: 110 }}>
                    <FaEdit /> Kilo Güncelle
                </ActionButton>
                <ActionButton onClick={() => setShowSatisModal(true)} style={{ backgroundColor: '#f3e5f5', color: '#7b1fa2', flex: 1, minWidth: 110 }}>
            ...
            <TabBar>
                {[
                    ...
                    <Tab key={s.key} $active={aktifSekme === s.key} onClick={() => setAktifSekme(s.key)}>{s.label}</Tab>
                ))}
            </TabBar>
                    ...
                    <Card>
                        ...
                        <div style={{ display: 'flex', gap: '20px' }}>
                            <div style={{
                                ...
                                border: yas < 3 ? '2px solid #16a34a' : '1px solid #ddd'
                            }}>
